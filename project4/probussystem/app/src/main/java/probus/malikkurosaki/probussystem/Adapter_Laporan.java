...
public class Adapter_Laporan extends RecyclerView.Adapter<Adapter_Laporan.VHolder> {
    ...
    public void onBindViewHolder(@NonNull VHolder holder, int position) {
        ...
        try{
            ...
            String agennya = !String.valueOf(datanya.get("agen")).contains("null")?String.valueOf(datanya.get("agen")):"";
            ...
            holder.laporanRoom.setText(String.valueOf(datanya.get("room")));
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    class VHolder extends RecyclerView.ViewHolder {
        ...
        VHolder(@NonNull View itemView) {
            ...
            laporanRoom = itemView.findViewById(R.id.laporanRoom);
