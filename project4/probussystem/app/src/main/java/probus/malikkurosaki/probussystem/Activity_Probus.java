...
public class Activity_Probus extends AppCompatActivity {
    ...
    @BindView(R.id.menuDeveloper)
    LinearLayout menuDeveloper;
    @BindView(R.id.menuSampingContainer)
    ViewAnimator menuSampingContainer;
    @BindView(R.id.chartTanggal)
    TextView chartTanggal;
    @BindView(R.id.internetMode)
    TextView internetMode;
    @BindView(R.id.lay2Web)
    WebView lay2Web;
    @BindView(R.id.lay2WebLoading)
    ProgressBar lay2WebLoading;
    ...
    // ok http untuk retrofit mode offline
    //====================================
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // tombol developer di klik
        // ========================
        menuDeveloper.setOnClickListener(v -> {
        ...
        // pengaturan retrofit mode client offline
        //========================================
        ...
        dashBSwipe.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                AlertDialog.Builder mauRefresh = new AlertDialog.Builder(Activity_Probus.this);
                mauRefresh.setMessage("get lates data ?");
                mauRefresh.setCancelable(true);
                mauRefresh.setNeutralButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                ...
                mauRefresh.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    @Override
    ...
    // webview pada halaman 2
    //=======================
    @SuppressLint("SetJavaScriptEnabled")
    public void webviewHal2() {
        lay2WebLoading.setVisibility(View.VISIBLE);
        lay2Web.getSettings().setJavaScriptEnabled(true);
        lay2Web.loadUrl("https://www.probussystem.com/");
        lay2Web.setWebViewClient(new WebViewClient() {
            @Override
            public void onPageFinished(WebView view, String url) {
                lay2WebLoading.setVisibility(View.GONE);
            }
        });
    }
    ...
    public void ambilTanggal() {
        new SingleDateAndTimePickerDialog.Builder(this)
                ...
                .backgroundColor(getResources().getColor(R.color.colorAbu4))
                .titleTextColor(getResources().getColor(R.color.colorBg1))
    ...
    public void cekBahaya(Response response) {
    ...
    public void dashboardNya() {
        ...
        chartTanggal.setText(Class_Dashboard.tahun());
        ...
        panggilArrival.enqueue(new Callback<List<JsonObject>>() {
            ...
            public void onResponse(Call<List<JsonObject>> call, Response<List<JsonObject>> response) {
                internetMode.setText("Online Mode");
                cekBahaya(response);
                isConnected = response.body() != null;
                // cek dan munculkan response jika source diambil dari network
                if (response.raw().networkResponse() != null) {
                    if (isConnected) {
                        internetMode.setText("Realtime Mode");
                    }
            ...
            public void onFailure(Call<List<JsonObject>> call, Throwable t) {
                ...
                isConnected = false;
                // 15 detik tidak ada response maka akan dianggap ofline
                internetMode.setText("Offline Mode");
            }
        });
