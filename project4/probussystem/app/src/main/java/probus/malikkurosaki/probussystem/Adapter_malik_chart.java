...
public class Adapter_malik_chart extends RecyclerView.Adapter<Adapter_malik_chart.VHolder> {
    ...
    public void onBindViewHolder(@NonNull VHolder holder, int position) {
        ...
        if ((Integer.parseInt(String.valueOf(dt.get("month")))-1) < 7){
            holder.chartCon.setBackground(context1.getResources().getDrawable(R.drawable.bg_chart1,context1.getTheme()));
        }else {
            holder.chartCon.setBackground(context1.getResources().getDrawable(R.drawable.bg_chart2,context1.getTheme()));
        }
    ...
    class VHolder extends RecyclerView.ViewHolder {
        ...
        VHolder(@NonNull View itemView) {
            ...
            chartCon = itemView.findViewById(R.id.chartCon);
